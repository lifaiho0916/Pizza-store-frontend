...
class Customization extends Component {
  ...
  componentDidMount() {
    ...
    .then(data => {
      ...
      let temp = this.state.doughData.filter((item) => item._id === JSON.parse(localStorage.getItem("product")).standard[0])[0].name
      this.setState({activeDough: temp})

      this.setState(prevState => {
        let selection = Object.assign({}, prevState.selection); 
        selection.dough = temp;
        return { selection };
      })
    })
    ...
    .then(data => {
      ...
      let temp = this.state.sauceData.filter((item) => item._id === JSON.parse(localStorage.getItem("product")).standard[1])[0].name
      this.setState({activeSauce: temp})

      this.setState(prevState => {
        let selection = Object.assign({}, prevState.selection); 
        selection.sauce = temp;
        return { selection };
      })
    })
    ...
    .then(data => {
      ...
      let temp = this.state.cheeseData.filter((item) => item._id === JSON.parse(localStorage.getItem("product")).standard[2])[0].name
      this.setState({activeCheese: temp})

      this.setState(prevState => {
        let selection = Object.assign({}, prevState.selection); 
        selection.cheese = temp;
        return { selection };
      })
    })
    ...
    .then(data => {
      ...
      let temp = this.state.specialData.filter((item) => item._id === JSON.parse(localStorage.getItem("product")).standard[3])[0].name
      this.setState({activeSpecialTopping: temp})

      this.setState(prevState => {
        let selection = Object.assign({}, prevState.selection); 
        selection.special = temp;
        return { selection };
      })
    })
          ...
          <div className="ingredients">
            {
              this.state.doughData.map((dough, index) => {
                return (
                  <div className={"base-item" + (activeBaseDough === dough._id ? " base-active" : "")}
                      onClick={() => handleDough(dough)}
                      key={dough._id}>
                  {
                    activeBaseDough === dough._id 
                    ? <div className="base-selected">
                      <div className="base-img-selected">
                        <LazyLoadImage src={StaticDough} />
                      </div>
                      <div className="base-detail-selected">
                        <div className="base-title-selected">{dough.name}</div>
                        <div className="line"/>
                        <div className="base-cals">{dough.cal} Cals</div>
                      </div>
                    </div>
                    : <div className="base-img-wrap">
                        <div className="base-detail">
                          <div className="title">Select</div>
                          <div className="base-name">{dough.name}</div>
                          <div className="line"/>
                          <div className="base-cal">{dough.cal + "Cals"}</div>
                        </div>
          ...
          <div className="ingredients">
            {
              this.state.sauceData.map((sauce, index) => {
                return (
                  <div className={"base-item" + (activeBaseSauce === sauce._id ? " base-active" : "")}
                      ...
                      key={sauce.name}>
                  {
                    ...
                    ? <div className="base-selected">
                      ...
                      <div className="base-detail-selected">
                        <div className="base-title-selected">{sauce.name}</div>
                        <div className="line"/>
                        <div className="base-cals">{sauce.cal} Cals</div>
                      </div>
                    </div>
                    : <div className="base-img-wrap">
                        <div className="base-detail">
                          <div className="title">Select</div>
                          <div className="base-name">{sauce.name}</div>
                          <div className="line"/>
                          <div className="base-cal">{sauce.cal + "Cals"}</div>
                        </div>
                        <div className="base-img">
                          <LazyLoadImage src={sauce.img} />
                        </div>
          ...
          <div className="ingredients">
            {
              this.state.cheeseData.map((cheese, index) => {
                return (
                  <div className={"base-item" + (activeBaseCheese === cheese._id ? " base-active" : "")}
                      ...
                      key={cheese.name}>
                  {
                    ...
                    ? <div className="base-selected">
                      ...
                      <div className="base-detail-selected">
                        <div className="base-title-selected">{cheese.name}</div>
                        <div className="line"/>
                        <div className="base-cals">{cheese.cal} Cals</div>
                      </div>
                    </div>
                    : <div className="base-img-wrap">
                        <div className="base-detail">
                          <div className="title">Select</div>
                          <div className="base-name">{cheese.name}</div>
                          <div className="line"/>
                          <div className="base-cal">{cheese.cal + "Cals"}</div>
                        </div>
                        <div className="base-img">
                          <LazyLoadImage src={StaticCheese} />
                        </div>
